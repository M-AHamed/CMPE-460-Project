...
catagory = ttk.Label(frame1, text="catagory").grid(row=2, column=0)

fuel_type = ttk.Label(frame1, text="fuel type").grid(row=3, column=0)
cylinders = ttk.Label(frame1, text="number of cylinders").grid(row=4, column=0)
driveWheels = ttk.Label(frame1, text="Drive wheels").grid(row=5, column=0)
doorsNumber = ttk.Label(frame1, text="number of doors").grid(row=6, column=0)
engineAspiration = ttk.Label(frame1, text="enigne aspiration").grid(row=7,
                                                                    column=0)
engineType = ttk.Label(frame1, text="engine type").grid(row=8, column=0)
engineLocation = ttk.Label(frame1, text="engine Location").grid(row=9,
                                                                column=0)
fuelSystem = ttk.Label(frame1, text="Fuel System").grid(row=10, column=0)
# prediction result:
...
def on_manufacturer_select(event):
    ...
    model_entry = ttk.OptionMenu(frame1, model_var, *models).grid(row=1,
                                                                  column=1)
    model = ttk.Label(frame1, text="Model ").grid(row=1, column=0)
...
fuelSystem = ttk.OptionMenu(frame1, fuelSystem_var,
                            *engineFuelSystem_options).grid(row=10, column=1)
